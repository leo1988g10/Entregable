...
VALUES 
    ('Horacio', 'Gutierrez', 'horacio@example.com', 'password', 'docente'),
    ('Maria', 'Gomez', 'maria@example.com', '123456', 'docente'),
    ('Carlos', 'Lopez', 'carlos@example.com', 'password8', 'editor'),
    ('Camila', 'Martinez', 'camila@example.com', 'p@ssw0rd', 'administrador'),
    ('Pedro', 'Rodriguez', 'pedro@example.com', 'password1', 'estudiante'),
    ('Ana', 'Sanchez', 'ana@example.com', 'password5', 'docente'),
    ('Lorena', 'Diaz', 'lorena@example.com', 'password3', 'editor'),
    ('Roberto', 'Gonzalez', 'roberto@example.com', 'password4', 'administrador'),
    ('Viviana', 'Ruiz', 'viviana@example.com', 'password2', 'estudiante'),
    ('Sergio', 'Hernandez', 'sergio@example.com', 'password6', 'docente');

INSERT INTO Usuarios (nombre, apellido, email, contrasena, categoria)
VALUES 
	('Gabriel', NULL, 'gabriel@example.com', '123452', 'estudiante'),
    ('Leonardo', NULL, 'leonardo@example.com', 'password10', 'docente'),
    (Null, 'Aravena', 'carlos@example.com', 'password12', 'editor'),
    (NULL, NULL, 'dario@example.com', 'password25', 'administrador');
